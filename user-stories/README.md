# ![JavaScript Browser Game - Rock, Paper, Scissors - User Stories](./assets/hero.png)
...
Build a refined Rock Paper Scissors game incorporating the web technologies and techniques you’ve worked with thus far:
